						...
						<tbody>
						  <c:forEach items="${phim}" var="p">
			                <tr>
			                    ...
			                    <td>
			                    <a class="btn-func btn btn-primary" href="/admin/showSuaPhim?idPhim=${p.id}" style="margin-left: 50px">
									<i class="fas fa-edit"></i>
								</a>&ensp;
								<a class="btn-func  btn btn-danger" href="/admin/xoaPhim?idPhim=${p.id}">
									<i class="fas fa-trash-alt"></i>
								</a>
								<button type="button" class="btn-func  btn btn-primary" data-toggle="modal" data-target="#exampleModal" value="${p.id}" id="clickmodal${p.id}">
									<i class="fas fa-plus-circle"></i> Thêm
								</button>
								<a class="btn-func btn btn-info"  href="/admin/suatTheoPhim?idPhim=${p.id}">
