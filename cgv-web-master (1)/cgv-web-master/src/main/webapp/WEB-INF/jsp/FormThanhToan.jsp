    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12 navbar" style="background-color: #1f1f24">
          <a href="/" class="logo navbar-brand text-red offset-md-2" style="color:red !important">CGGV</a>
                ...
                <div class="card">
                  ...
                  <c:url value="/chonve/pay" var="payUrl"/>
                    <form:form action="${payUrl}" method="post">
                      ...
                      <a  href="/chonve/suat?id=${idSuat}" class="btn btn-warning" style="    display: flex;
    margin: auto;
    justify-content: center;
    width: 200px;">Quay lại</a>
                     
							
						<button type="submit" id="btnThanhToan" class="btn btn-success" style="    display: flex;
    margin: auto;
    justify-content: center;
    width: 200px;">Thanh Toán</button>
